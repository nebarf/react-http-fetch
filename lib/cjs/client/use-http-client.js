...
var useHttpClient = function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        mergedOptions = {
                            method: method || defaultOptions.method || __1.HttpMethod.Get,
                    ...
                    case 2:
                        ...
                        if (!response.ok) {
                            ...
                            httpError = new __1.HttpError(statusText || 'Http Error', status_1, requestInfo, statusText);
                    ...
                    case 3:
                        error_1 = _d.sent();
                        httpError = new __1.HttpError((error_1 === null || error_1 === void 0 ? void 0 : error_1.message) || 'Http Error', (error_1 === null || error_1 === void 0 ? void 0 : error_1.status) || undefined, requestInfo);
                        requestErroredEvent = new events_manager_1.RequestErroredEvent(httpError);
                        eventBus.publish(requestErroredEvent);
    ...
    var get = (0, react_1.useCallback)(function (params) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, requestByMethod(params, __1.HttpMethod.Get)];
        });
    }); }, [requestByMethod]);
    /**
    ...
    var post = (0, react_1.useCallback)(function (params) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, requestByMethod(params, __1.HttpMethod.Post)];
        });
    }); }, [requestByMethod]);
    /**
