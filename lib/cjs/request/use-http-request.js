...
var use_compare_callback_1 = require("@/shared/use-compare-callback");
var useHttpRequest = function (params) {
    /**
     * Grabs the "request" function from the http client.
     */
    var httpClientRequest = (0, client_1.useHttpClient)().request;
     ...
     */
    var request = (0, use_compare_callback_1.useCompareCallback)(function () { return __awaiter(void 0, void 0, void 0, function () {
