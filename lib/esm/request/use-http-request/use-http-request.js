...
import { requestError, requestInit, requestSuccess } from './action-creators';
import { httpRequestReducer, initialState } from './state-reducer';
...
export var useHttpRequest = function (params) {
    ...
    var _a = useReducer(httpRequestReducer, initialState(params.initialData)), state = _a[0], dispatch = _a[1];
    /**
     ...
     */
    var safelyDispatch = useCallback(function (action) {
     ...
     */
    var request = useCompareCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    ...
                    safelyDispatch(requestError(error_1));
                    throw error_1;
                case 4: return [2 /*return*/];
            }
        });
    }); }, [httpClientRequest, params, safelyDispatch], function (prev, actual) { return fastCompare(prev, actual); });
    /**
